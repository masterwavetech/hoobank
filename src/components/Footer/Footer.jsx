...
import { footerLinks, socialMedia } from "../../Api/index";

const Footer = () => {
  return (
    <section className="flex justify-center items-center flex-col py-6 sm:py-16">
      <div className="flex justify-center items-start flex-col mb-5 w-full md:flex-row">
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45] mt-2">
        <p className="font-poppins font-normal text-center text-[14px] leading-[27px] text-white">
          Copyright Ⓒ 2022 MasterwaveTech. All Rights Reserved.
        </p>
